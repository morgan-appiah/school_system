...
from school_system_app.models import Courses, SessionYearModel, Subjects
...
#    username=forms.CharField(label="Username",max_length=50,widget=forms.TextInput(attrs={"class":"form-control","autocomplete":"off"}))
#    address=forms.CharField(label="Address",max_length=50,widget=forms.TextInput(attrs={"class":"form-control"}))
#    puk=forms.CharField(label="Staff ID",max_length=50,widget=forms.TextInput(attrs={"class":"form-control"}))
#    contact=forms.CharField(label="Contact",max_length=50,widget=forms.TextInput(attrs={"class":"form-control"}))
#    bank_name=forms.CharField(label="Bank",max_length=50,widget=forms.TextInput(attrs={"class":"form-control"}))
#    bank_account=forms.CharField(label="Account Number",max_length=50,widget=forms.TextInput(attrs={"class":"form-control"}))
#    salary=forms.FloatField(label="Salary Amount",widget=forms.NumberInput(attrs={"class":"form-control"}))
#    allowance=forms.FloatField(label="Allowance",widget=forms.NumberInput(attrs={"class":"form-control"}))
#    ezwich=forms.CharField(label="E-Zwich Number",max_length=50,widget=forms.TextInput(attrs={"class":"form-control"}))
#    momo_number=forms.CharField(label="MoMo Number",max_length=50,widget=forms.TextInput(attrs={"class":"form-control"}))
#    profile_pic=forms.FileField(label="Profile Pic",max_length=50,widget=forms.FileInput(attrs={"class":"form-control"}))
