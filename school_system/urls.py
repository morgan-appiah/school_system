...
urlpatterns = [
    ...
    path('delete_employee/<str:employee_id>', HodViews.delete_employee, name="delete_employee"),
    ...
    path('delete_accounts/<str:accounts_id>', HodViews.delete_accounts, name="delete_accounts"),
    ...
    path('delete_stage/<str:stage_id>', HodViews.delete_stage, name="delete_stage"),
